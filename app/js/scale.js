define(function () {
  ...
  // scale a fixed height+width container with the window to ensure
  // that it is as large as possible (i.e. always in landscape
  // if on a mobile device); this uses workarounds for platforms
  // where orientation cannot be locked or is not reported
  //
  // ideally, container should use block display with height and width
  // fixed to pixel values
  //
  // container: DOM element to scale
  // mobileWidth: width at which we should apply a fake orientation
